  ...
  return (
    <main className="mx-auto max-w-6xl px-4 py-12">
      ...
      <div className="mt-4 flex flex-wrap items-center gap-3">
        <a
          href="https://ywdge1xkgtfse3yp.public.blob.vercel-storage.com/flavio/bitacora-entrenamientos-2025.pdf"
          target="_blank"
          rel="noreferrer"
      ...
      <div className="mt-6 overflow-hidden rounded-2xl border border-slate-200 bg-white">
        <iframe
          ...
          src="https://ywdge1xkgtfse3yp.public.blob.vercel-storage.com/flavio/bitacora-entrenamientos-2025.pdf"
